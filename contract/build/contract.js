    ...
    (_class =
      ((_class2 = class Contract extends NearContract {
        ...
        addPrices(request_data) {
          assert(
            signerAccountId() === AUTHORIZED_ACCOUNT ||
              signerAccountId() === TEST_ACCOUNT,
            `Account ${signerAccountId()} unathourized to add data to smart contract.`
          );
      ...
      (_applyDecoratedDescriptor(
        ...
        "addPrices",
        [call],
        Object.getOwnPropertyDescriptor(_class2.prototype, "addPrices"),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        "getPrices",
        [view],
        Object.getOwnPropertyDescriptor(_class2.prototype, "getPrices"),
        _class2.prototype
      )),
      _class2))
  ) || _class;
